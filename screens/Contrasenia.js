...
export default function App() {
    ...
    return (
        <SafeAreaView style={{ flex: 1, justifyContent: 'center', alignItems:'center' }}>
            ...
            <TextPersonalizados text="¿Olvido su contraseña?"/>
            <TextInputPer text="Ingresa tu correo electronico"/>
            <TextInputPerButt text="Clave"/>
            <BlueButtton onPress= {() => navegacion.navigate("Nuevo")} text="Continuar"/>
